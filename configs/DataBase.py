...
import asyncpg, psycopg, asyncio
...
sync_engine = create_engine(url = sync_url, echo = env.DEBUG_MODE)
async_engine=create_async_engine(url=async_url,echo=env.DEBUG_MODE)
